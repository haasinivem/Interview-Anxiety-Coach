...
function Feedback({ params }) {
  const interviewid = params?.interviewid; // 👈 just access directly
  ...
  const GetInterviewData = async () => {
    const mockData = [
      {
        ...
        correctanswer:
          "Discuss your background and experience relevant to the role.",
        useranswer: "",
        feedback:
          "Your answer was too short. Please elaborate more with specific examples.",
        rating: "1",
      },
      {
        id: 2,
        ...
        correctanswer:
          "Focus on relevant technical skills and back them with examples.",
        useranswer: "",
        feedback:
          "Your answer was too short. Please elaborate more with specific examples.",
        rating: "1",
      ...
      {
        id: 3,
        question: "Describe a challenge you faced as a Software Developer?",
        correctanswer: "Use the STAR method - Situation, Task, Action, Result.",
        useranswer: "",
        feedback:
          "Your answer was too short. Please elaborate more with specific examples.",
        rating: "1",
      },
      {
        ...
        correctanswer:
          "Connect your personal goals to the company's mission and values.",
        useranswer: " ",
        feedback:
          "Your answer was too short. Please elaborate more with specific examples.",
        rating: "1",
      },
      {
        ...
        correctanswer:
          "Show ambition and commitment while aligning with the company's growth.",
        useranswer: "",
        feedback:
          "Your answer was too short. Please elaborate more with specific examples.",
        rating: "1",
    ...
    calculateAverageRating(mockData);
  };
